...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    y=mod.encontrar_pelicula_mas_larga(p1, p2, p3, p4, p5)
    print(y)
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    y=mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5)
    print(y)
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    y=mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio)
    print(y)
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    y=mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)
    print(y)
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    nombre = input("Ingrese el nombre de la pelicula que desea reagendar: ").lower()
    ...
    if pelicula is None:
        ...
        nuevo_dia=input("Ingrese el nuevo día en el que desea ver la pelicula: ").lower()
        a='áéíóúü'
        b='aeiouu'
        trans = str.maketrans(a,b)
        nuevo_dia.translate(trans)
        control_horario=input("¿Desea control de horario? (si o no): ").lower()
        control_horario="s" in control_horario
        nueva_hora=int(input("Ingrese la nueva hora: "))   
        y=mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)
        print(y)
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        autorizacion_padres=input("¿Tiene autorizacion de sus padres? (si o no): ").lower()
        autorizacion_padres="s" in autorizacion_padres
